...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "d864b6a0a6c32cc740b5";
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _css_index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./css/index.css */ \"./src/css/index.css\");\n/* harmony import */ var _css_index_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_css_index_css__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _lib_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/index.js */ \"./src/lib/index.js\");\n/* harmony import */ var _lib_index_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_lib_index_js__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _images_face_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./images/face.png */ \"./src/images/face.png\");\n/* harmony import */ var _images_rocket_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./images/rocket.png */ \"./src/images/rocket.png\");\n/* harmony import */ var _images_flower_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./images/flower.png */ \"./src/images/flower.png\");\n\n\n\n\n\n\nvar parentBox = document.querySelector('.message-area');\nvar Mes = new _lib_index_js__WEBPACK_IMPORTED_MODULE_1___default.a(parentBox, {\n    format: function(mesItem) {\n        if (mesItem.type === 'rocket') {\n            return `<img src=\"${_images_rocket_png__WEBPACK_IMPORTED_MODULE_3__[\"default\"]}\" class=\"icon icon-rocket\"/><span>${mesItem.text}</span>`\n        } else if (mesItem.type === 'flower') {\n            return `<img src=\"${_images_flower_png__WEBPACK_IMPORTED_MODULE_4__[\"default\"]}\" class=\"icon icon-flower\"/><span>${mesItem.text}</span><img src=\"${_images_flower_png__WEBPACK_IMPORTED_MODULE_4__[\"default\"]}\" class=\"icon icon-flower\"/>`\n        } else if (mesItem.type === 'face') {\n            return `<img src=\"${_images_face_png__WEBPACK_IMPORTED_MODULE_2__[\"default\"]}\" class=\"icon icon-face\"/><span>${mesItem.text}</span>`\n        }\n        \n    }\n});\nfunction loop() {\n    var data = [\n        {\n            type: 'face',\n            text: '笑一个，大兄弟'\n        },\n        {\n            type: 'flower',\n            text: '鲜花送上'\n        },\n        {\n            type: 'rocket',\n            text: '小火箭飞一个'\n        }\n    ]\n    var random = Math.random();\n    if (random > 0.7) {\n        data = [\n            {\n                type: 'face',\n                text: '笑一个，大兄弟'\n            },\n            {\n                type: 'flower',\n                text: '鲜花送上'\n            },\n            {\n                type: 'rocket',\n                text: '小火箭飞一个'\n            }\n        ]\n    } else if (random > 0.5){\n        data = [\n            {\n                type: 'face',\n                text: '笑一个，大兄弟'\n            },\n            {\n                type: 'rocket',\n                text: '小火箭飞一个'\n            }\n        ]\n    } else if (random > 0.3){\n        data = [\n            {\n                type: 'rocket',\n                text: '小火箭飞一个'\n            }\n        ]\n    } else {\n        data = [\n            {\n                type: 'face',\n                text: '笑一个，大兄弟'\n            }\n        ]\n    }\n    Mes.send(data);\n    setTimeout(function() {\n        loop()\n    }, 3000)\n}\nloop();\ndocument.querySelector('.send-btn').addEventListener('click', function() {\n    var text = document.querySelector('.send-input').value;\n    Mes.send(text);\n})\n\n//# sourceURL=webpack:///./src/main.js?");
